...
.constant("Config", {
	"searchPath":(typeof conTextPathVal !== "undefined") ? conTextPathVal + ((document.documentElement.lang=="fr-CA")?"/recherche/": "/search/") : "/ca/en/personal-banking/search/",
	"endpoints":{
		"suggestions":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/kb/predictionsOnTerms/" : "/ca/en/personal-banking/kb/predictionsOnTerms/",
		"answer":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/kb/responseAnswer/" : "/ca/en/personal-banking/kb/responseAnswer/",
		"topQuestions":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/kb/topAskedQuestions/?interfaceID=:interfaceId&sessionID=:sessionId&sourceID=4" : "/ca/en/personal-banking/kb/topAskedQuestions/?interfaceID=:interfaceId&sessionID=:sessionId&sourceID=4",
		"singleAnswer":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/kb/description/" : "/ca/en/personal-banking/kb/description/",
		"gsaSearch":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/gsa/search/?q=:query&lang=en" : "/ca/en/personal-banking/gsa/search/?q=:query&lang=en",
		"gsaSuggestion":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/gsa/suggest?token=:query&lang=:language" : "/ca/en/personal-banking/gsa/suggest?token=:query&lang=:language",
		"contact":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/system/assets/contactus.json" : "/ca/en/personal-banking/system/assets/contactus.json",
		"helpCentre":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/system/assets/helpcentre.json" : "/ca/en/personal-banking/system/assets/helpcentre.json",
		"chatSettings":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/system/assets/askaquestion.json" : "/ca/en/personal-banking/system/assets/askaquestion.json",
		"getSession":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/kb/getSession/?interfaceID=:interfaceId" : "/ca/en/personal-banking/kb/getSession/?interfaceID=:interfaceId",
		"gsaSuggestions":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/gsa/suggest/?token=:query&lang=:language" : "/ca/en/personal-banking/gsa/suggest/?token=:query&lang=:language",
		"emailList":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/system/assets/emailforms.json" : "/ca/en/personal-banking/system/assets/emailforms.json",
		"topSearchTerms":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/system/assets/topsearchterms.json" : "/ca/en/personal-banking/system/assets/topsearchterms.json",
		"rateResponse":(typeof conTextPathVal !== "undefined") ? conTextPathVal + "/kb/rateResponse/" : "/ca/en/personal-banking/kb/rateResponse/"
	},
	"language": (document.documentElement.lang=="fr-CA")? "fr":"en"
});
...
angular.module('SelfHelp').component('question', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/question.html':'/ca/en/personal-banking/selfHelpComponents/question.html',
...
angular.module('SelfHelp').component('search', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/search.html':'/ca/en/personal-banking/selfHelpComponents/search.html',
...
angular.module('SelfHelp').component('helpCentre', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/helpCentre.html':'/ca/en/personal-banking/selfHelpComponents/helpCentre.html',
...
function contactCtrl(Backend, LibraryHelper, ngDialog, $scope, $timeout) {
    ...
    this.showLoginModal = function() {
        ...
        ngDialog.open({
            template: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/loginModal.html':'/ca/en/personal-banking/selfHelpComponents/loginModal.html',
            width: '800px',
            scope: $scope,
    ...
    this.showTextUsModal = function() {
        ngDialog.open({
            template: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/textUsModal.html':'/ca/en/personal-banking/selfHelpComponents/textUsModal.html',
            width: '800px',
            onOpenCallback: focusOnDismissButton
        });
    };
...
angular.module('SelfHelp').component('contact', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/contact.html':'/ca/en/personal-banking/selfHelpComponents/contact.html',
...
angular.module('SelfHelp').component('globalHeader', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/globalHeader.html':'/ca/en/personal-banking/selfHelpComponents/globalHeader.html',
...
angular.module('SelfHelp').component('questionInput', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/questionInput.html':'/ca/en/personal-banking/selfHelpComponents/questionInput.html',
...
angular.module('SelfHelp').component('globalFooter', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/globalFooter.html':'/ca/en/personal-banking/selfHelpComponents/globalFooter.html'
});
...
angular.module('SelfHelp').component('popularTopics', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/popularTopics.html':'/ca/en/personal-banking/selfHelpComponents/popularTopics.html',
...
angular.module('SelfHelp').component('answer', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/answer.html':'/ca/en/personal-banking/selfHelpComponents/answer.html',
    bindings: {
        value: '='
    }
});
...
angular.module('SelfHelp').component('relatedQuestions', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/relatedQuestions.html':'/ca/en/personal-banking/selfHelpComponents/relatedQuestions.html',
...
angular.module('SelfHelp').component('feedback', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/feedback.html':'/ca/en/personal-banking/selfHelpComponents/feedback.html',
...
angular.module('SelfHelp').component('readMore', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/readMore.html':'/ca/en/personal-banking/selfHelpComponents/readMore.html',
...
angular.module('SelfHelp').component('topResult', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/topResult.html':'/ca/en/personal-banking/selfHelpComponents/topResult.html',
...
angular.module('SelfHelp').component('topSearchTerms', {
    templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/topSearchTerms.html':'/ca/en/personal-banking/selfHelpComponents/topSearchTerms.html',
...
angular.module('SelfHelp').service('Backend', function($cookies, $http, $q, $sce, $window, Config, QueryParams) {
    ...
    var interfaceId;
		if(typeof interfaceID !== "undefined")  {
			...
			interfaceId = Config.language === 'fr' ? 32 : 17;
		}
    var sessionId;
    ...
    function sendRating(rating, submitTarget, comment, uuid) {
...
angular.module('SelfHelp').directive('suggestions',function(Backend) {
    ...
    return {
        ...
        templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/suggestions.html':'/ca/en/personal-banking/selfHelpComponents/suggestions.html'
    }
});
...
angular.module('SelfHelp').directive('headerSearchInput',function(Backend, Config, QueryParams, $window) {
    ...
    return {
        link: function(scope, elem, attrs) {
            ...
            scope.$ctrl.updateSuggestions = function() {
                Backend.getSuggestions(scope.query).then(function(response) {
					...
					var $_this = angular.element(elem[0].tagName).find('input[type=text]');
					if(typeof scope.$ctrl.suggestions === 'object'){
						if(scope.$ctrl.suggestions.length > 0){
							$_this.attr('aria-haspopup',true);
							$_this.attr('aria-expanded',true);
						}else{
							$_this.attr('aria-haspopup',false);
            ...
            if (scope.query) {
				if($('.td-nav-desktop-search').get(0)) $('.td-nav-desktop-search').show();
                if($('header-search-input input[type="text"]').get(0)) $('header-search-input input[type="text"]').val(scope.query);
				
				var $header_desktop_nav_primary = $('.td-header-desktop .td-nav-primary');
				if($header_desktop_nav_primary.get(0)){
					var $header_desktop_nav_primary_left = $header_desktop_nav_primary.find('.td-section-left'),
						$header_desktop_nav_primary_right = $header_desktop_nav_primary.find('.td-section-right');
					$header_desktop_nav_primary_left.find('nav').attr('aria-hidden',true);
					$header_desktop_nav_primary_left.find('nav a').attr('tabindex','-1');
					$header_desktop_nav_primary_right.attr('aria-hidden',true);
					$header_desktop_nav_primary_right.find('a').attr('tabindex','-1');
				}
            }
        ...
        templateUrl: (typeof conTextPathVal !== "undefined") ? conTextPathVal +'/selfHelpComponents/headerSearchInput.html':'/ca/en/personal-banking/selfHelpComponents/headerSearchInput.html'
    }
});
